...
P.S. Great thanks mattn's [PR](https://github.com/yang-ricky/air/pull/1) for supporting Windows platform.
...
```bash
go install github.com/yang-ricky/air@latest
```
